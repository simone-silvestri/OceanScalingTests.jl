...
function set_boundary_conditions(::Val{:DoubleDrake})
    ...
    u_bot_bc = FluxBoundaryCondition(u_linear_bottom_drag, discrete_form=true, parameters = 0.003)
    v_bot_bc = FluxBoundaryCondition(v_linear_bottom_drag, discrete_form=true, parameters = 0.003)
